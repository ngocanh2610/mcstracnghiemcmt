  ...
  return (
    <div className="card admin-card animate-fade-in" style={{ marginTop: '20px', background: '#fff1f1', padding: '24px', borderRadius: '12px', border: '2px solid #fecaca', boxShadow: '0 10px 15px -3px rgba(0, 0, 0, 0.1)' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '25px' }}>
        <div className="admin-header" style={{ padding: '20px', background: '#f8f9fa', borderRadius: '10px', marginBottom: '20px', borderLeft: '6px solid #4f46e5' }}>
          <h2>⚙️ QUẢN TRỊ HỆ THỐNG - ADMIN PANEL</h2>
          <p style={{ color: 'gray' }}>Hệ thống quản lý cốt lõi được thiết kế và bảo trì bởi Ngọc Anh.</p>
          <button style={{ background: '#4f46e5', color: 'white', padding: '10px 20px', border: 'none', borderRadius: '5px' }}>Tải báo cáo hệ thống</button>
        </div>
